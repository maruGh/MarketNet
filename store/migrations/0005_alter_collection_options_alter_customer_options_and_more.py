...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('store', '0004_rename_created_at_order_placed_at'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='unit_price',
            field=models.DecimalField(decimal_places=4, max_digits=6, validators=[django.core.validators.MinValueValidator(10)]),
        ),
    ]
